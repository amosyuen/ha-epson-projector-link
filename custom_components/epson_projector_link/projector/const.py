...
# Auto Iris
#
# Should keep in sync with epson_projector_hc/services.yaml select_auto_iris_mode options
...
# Color Modes
#
# Should keep in sync with epson_projector_hc/services.yaml select_color_mode options
COLOR_MODE_CODE_MAP = {
    "00": "Auto",
    "05": "Theatre",
    "06": "Dynamic",
...
# Power Consumption
#
# Should keep in sync with epson_projector_hc/services.yaml select_power_consumption_mode options
